...
const ManageBlogs = () => {
  ...
  return (
    <>
        ...
        <input type="search" className={'w-full bg-drey p-4 pl-12 pr-6 rounded-full placeholder:text-dark-grey ' + (theme == 'dark'? 'bg-zinc-800 text-yellow-50 placeholder:text-zinc-400' : 'bg-drey text-black placeholder:text-dark-grey')} placeholder='Search Blogs' onChange={handleChange} onKeyDown={handleSearch}/>
