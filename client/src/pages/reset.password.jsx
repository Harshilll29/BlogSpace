    ...
    <div className="h-cover flex items-center justify-center">
      <form className="w-[80%] max-w-[400px]" onSubmit={handleResetPassword}>
        ...
        <div className="relative">
          <i className="fi fi-rr-key absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
          <input
            type="text"
        ...
        {errorMsg && (
          <p className="absolute text-red text-center font-semibold mb-4 mt-1">
            {errorMsg}
          </p>
        )}
