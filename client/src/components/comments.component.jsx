...
export const fetchCommnts = async ({skip = 0, blog_id, setParentCommentCountFun, comment_array = null}) =>{
...
const CommentsContainer = () => {
    ...
    const loadMoreComments = async() =>{
        let newCommentsArr = await fetchCommnts({ skip: totalParentCommentsLoaded, blog_id: _id, setParentCommentCountFun: setTotalParentCommentsLoaded, comment_array: commentsArr })
