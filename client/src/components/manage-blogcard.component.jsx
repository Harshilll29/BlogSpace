    ...
    <div className='flex gap-2 max-lg:mb-6 max-lg:pb-6 border-grey max-lg:border-b'>
        {
          Object.keys(stats).map((key, i)=>{
            return !key.includes('parent') ? <div key={i} className={'flex flex-col items-center w-full h-full p-4 px-6 justify-center ' + (i != 0 ? " border-grey border-l " : "")}>
...
const ManagePublishedBlogCard = ({blog}) => {
  ...
  return (
    ...
    <img src={`${import.meta.env.VITE_SERVER_DOMAIN}/media/${banner}`}  className='max-md:hidden lg:hidden xl:block w-28 h-28 flex-none bg-grey object-cover'/>
