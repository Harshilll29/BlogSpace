...
const Navbar = () => {
  const [searchVisibality, setSearchVisibality] = useState(false);
    ...
    <div>
      <nav className="navbar z-50">
        <Link to="/" className="flex-none w-36">
          <img src={theme == 'light' ? darkFullLogo : lightFullLogo} />
        </Link>
        ...
        <div className="flex items-center gap-3 md:gap-6 ml-auto">
          <button
            ...
            onClick={() => setSearchVisibality((currentVal) => !currentVal)}
          >
          ...
          <Link className="hidden md:flex gap-2 link rounded-full" to="/editor">
          ...
          {access_token ? (
            <>
              <Link to="/dashboard/notifications">
                <button
                  className="w-12 h-12 rounded-full bg-grey relative
           hover:bg-black/10"
                >
              ...
              <div
                ...
                onBlur={handleBlur}
              >
                <button className="w-12 h-12 mt-1.5">
                  <img
                    src={profile_img}
