...
const BlogPostCard = ({ content, author }) => {
  ...
  return (
    <Link to={`/blog/${id}`} className='flex gap-8 items-center border-b border-grey pb-5 mb'>
      ...
      <div className='h-28 aspect-square bg-grey'>
        <img src={`${import.meta.env.VITE_SERVER_DOMAIN}/media/${banner}`} alt='blog-banner' className='w-full h-full aspect-square object-cover'/>
      </div>
    </Link>
  )
}
