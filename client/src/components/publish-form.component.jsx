...
const PublishForm = () => {
  ...
  const publishBlog = (e) => 
    ...
    if (!des.length || des.length > characterLimit) {
      return toast.error(
        `Write a description about your blog within ${characterLimit} chracters to publish `
      );
    }
    if (!tags.length) {
    ...
    axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/create-blog", {...blogObj, id: blog_id}, {headers: {'Authorization': `Bearer ${access_token}`}})
    .then(() =>{
    ...
    <div>
      <Animation>
        <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
          ...
          <div className="border-grey lg:border-1 lg:p-8">
